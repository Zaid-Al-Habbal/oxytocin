...
class AddAssistantSerializer(serializers.Serializer):
    ...
    def validate_assistant_phone(self, value):
        try:
            ...
            raise serializers.ValidationError(_("There is no assistant with this phone number!"))

        if assistant.clinic is not None:
            raise serializers.ValidationError(_("This assistant is already connected to a clinic."))
